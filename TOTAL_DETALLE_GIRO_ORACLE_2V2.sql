/* ============================================================================
   TOTAL_DETALLE_GIRO_ORACLE_2V2.sql
   Conversion de SQL Server -> Oracle, compatible con GoAnywhere MFT (JDBC).
   Version de origen: 2_v2.

   Unica diferencia respecto a la version 1_v2 (ver TOTAL_DETALLE_GIRO_ORACLE.sql):
   - La comparacion final contra CORTE DISPERSION pasa de '=' a '>'.
   - El filtro IdDesembolsodetalle IN (1,2,6,7) y el resto de la logica se
     mantienen igual que en 1_v2.
